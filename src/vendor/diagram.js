      ...
      y = (function(t) {
        ...
        return (
          ...
          (e.prototype.collapseItem = function(t) {
            this.events.fire(_.DiagramEvents.beforeCollapse, [t]) &&
              (this.data.update(t, {
                open: !1
              }),
          ...
          (e.prototype.expandItem = function(t) {
            this.events.fire(_.DiagramEvents.beforeExpand, [t]) &&
              (this.data.update(t, {
                open: !0
              }),
          ...
          (e.prototype.text = function() {
            ...
            function createEl(node) {
              ...
              for (var i = 0; i < node.childNodes.length; i++) {
                _childs.push(createEl(node.childNodes[i]))
              }
              if (node.tagName) {
                var attributes = {}
                ...
                return o.el(node.tagName.toLowerCase(), attributes, _childs)
              } else {
            ...
            if (t.html) {
              ...
              tmpDiv.innerHTML = t.html
              for (var ih = 0; ih < tmpDiv.childNodes.length; ih++) {
                htmlChilds.push(createEl(tmpDiv.childNodes[ih]))
              }
              return [
                o.el(
                  'div',
                  {
                    class: 'dhx_content_html'
                  },
                  htmlChilds
                )
              ]
        ...
        function e(e, n) {
          ...
          return (
            ...
            r.events.on(s.DataEvents.change, function(t, e, n) {
              'remove' === e && (r._removeNested(n), r._removeCore(n.$parent)),
                'add' === e &&
                  n.parent &&
                  r._addCore(
                    {
