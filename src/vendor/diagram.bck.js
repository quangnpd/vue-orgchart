...
*/ !(function(
  ...
  function(t, e, n) {
    ...
    ;(e.getScrollbarWidth = function() {
      ...
      (e.fitPosition = function(t, e, n, r) {
        ...
        return (
          o + r > window.innerHeight && (o - r > 0 ? (a = o - r + window.scrollY) : ((s = 'scroll'), (r = 0.8 * (window.innerHeight - t.top)))),
          { position: 'absolute', left: l, top: a, minWidth: n, overflow: s, height: r }
        )
      })
  },
  function(t, e, n) {
  ...
  function(t, e, n) {
    ...
    var r = (function() {
      function t(t) {
        ;(this.config = this.setDefaults(t)),
          (this.id = t.id),
      ...
      l = (function(t) {
        ...
        return (
          ...
          (e.prototype.toSVG = function() {
            ...
            return o.sv(
              'g',
              { _key: t.id, transform: 'translate(' + r.x + ',' + r.y + ') rotate(' + (t.angle || 0) + ',' + e.x + ',' + e.y + ')', class: this.getCss(), dhx_id: t.id },
              [
  ...
  function(t, e, n) {
    ...
    function i(t, e, n) {
      var i = {
        top: { x: (t = r({}, t)).x + t.width / 2, y: t.y - e },
        bottom: { x: t.x + t.width / 2, y: t.y + t.height + e },
        left: { x: t.x - e, y: t.y + t.height / 2 },
        right: { x: t.x + t.width + e, y: t.y + t.height / 2 }
      }
      return n
    ...
    Object.defineProperty(e, '__esModule', { value: !0 }),
      ...
      (e.directLinkPath = function(t, e, n, r) {
        ...
        if ('vertical' === e.dir) {
          ...
          t.points = [{ x: l, y: c }, { x: l + d, y: c }, { x: l + d, y: h }, { x: u, y: h }]
        } else
          (l = Math.round(i + e.width / 2)),
            ...
            (t.points = [{ x: l, y: c }, { x: l, y: c + d }, { x: u, y: c + d }, { x: u, y: h }])
      })
  },
  function(t, e, n) {
    'use strict'
    ...
    ;(e.getCircleTpl = function(t) {
      ...
      return r.sv('g', { x: s.x, y: s.y, dhx_diagram: 'hide', class: n ? 'dhx_expand_icon' : 'dhx_hide_icon' }, [
        r.sv('circle', { r: 10, cx: s.x, cy: s.y, fill: t.$expandColor }),
        a
      ])
    }),
      ...
      (e.getTextTemplate = function(t, e) {
        return t.text || t.title
          ? r.sv('foreignObject', { width: t.width, overflow: 'hidden', height: t.height, transform: 'translate(0 0)' }, [
              r.el('div', { class: 'shape_content', style: 'width:' + t.width + 'px;height:' + t.height + 'px;' }, e)
            ])
          : null
      })
  },
      ...
      h = (function() {
        ...
        return (
          ...
          (t.prototype.copy = function(t, e, n, i) {
            ...
            return n
              ? i
                ? void n.add(r({}, this.getItem(t)), e, i)
                : n.exists(t)
                  ? (n.add(r({}, this.getItem(t), { id: o }), e), o)
                  : (n.add(this.getItem(t), e), t)
              : (this.add(r({}, this.getItem(t), { id: o }), e), o)
          }),
        ...
        return (
              ...
              a.el('.dhx_diagram.dhx_widget', this._htmlevents, [
                a.el('.dhx_wrapper', { class: s }, [
                  a.sv('svg', { xmlns: 'http://www.w3.org/2000/svg', width: l, height: c, viewBox: n.left + ' ' + n.top + ' ' + i + ' ' + o }, [
                    a.sv('defs', [
                      a.sv('filter', { x: 0, y: 0, width: 1, height: 1, id: 'dhx_text_background' }, [
                        a.sv('feFlood', { 'flood-color': 'white' }),
          ...
          (e.prototype._set_defaults = function() {
            ;(this.config = s.extend(
              { defaultShapeType: 'card', defaultLinkType: 'line', lineGap: 10, scale: 1, margin: { x: 40, y: 40, itemX: 40, itemY: 40 }, gridStep: 10 },
              this.config
            )),
    ...
    ;(r = function() {
                      ...
                      : (null == i.type && (n[r] = i = S('' + i)),
                        i.type === e
                          ? null == i.body || '' === i.body
                            ? n.splice(r--, 1)
                            : r > 0 && n[r - 1].type === e
                              ? ((n[r - 1].body += i.body), n.splice(r--, 1))
                              : L(i, t, r, null)
                          : L(i, t, r, null))
                }
                var o, s, a, l
      ...
      function Y(t, e, n) {
        var r = e._node,
          i = null != e.parentNode,
          o = e !== n && i ? null : r.vm
        null != o && V(o.hooks, 'willMount', o, o.data),
          V(r.hooks, i ? 'willReinsert' : 'willInsert', r),
          t.insertBefore(e, n),
          V(r.hooks, i ? 'didReinsert' : 'didInsert', r),
          null != o && V(o.hooks, 'didMount', o, o.data)
      }
      function U(t, e, n) {
        Y(t, e, n ? B(n) : null)
      }
      ...
      var mt = (yt.prototype = {
        ...
        mount: function(t, e) {
          ...
          e
            ? (Z({ el: t, flags: 0 }),
              ...
              t.nodeName.toLowerCase() !== n.node.tag ? (ot(n.node), Y(t.parentNode, n.node.el, t), t.parentNode.removeChild(t)) : Y(t.parentNode, ot(n.node, t), t))
        ...
        config: function(t) {
          ...
          t.init && (e.init = t.init),
            ...
            t.hooks && (e.hooks = p(e.hooks || {}, t.hooks)),
            t.onemit && (e.onemit = p(e.onemit || {}, t.onemit))
        },
        parent: function() {
            ...
            if (((n.x += o), (n.y += s), a.gridStep && (n.y = Math.ceil(n.y / a.gridStep) * a.gridStep), (s += n.height + a.margin.itemY), !1 !== n.open && c))
              for (var d = void 0, f = 0; f < c.length; f++)
                if (!(d = e.getItem(c[f][1])).hidden) {
                  ...
                  u ? ((s += p + a.margin.itemY), (h += p + a.margin.itemY)) : ((h = Math.max(h, p + a.margin.itemY)), (o += d.$width + a.margin.itemX)),
                    r.directLinkPath(e.getItem(c[f][0]), n, d, a)
                }
            if (c) {
          ...
          (t.prototype.remove = function(t) {
            return (
              ...
              (!!this.events.fire(i.SelectionEvents.beforeUnSelect, [t]) &&
                (this._data.update(t, { $selected: !1 }, !0), (this._selected = null), this.events.fire(i.SelectionEvents.afterUnSelect, [t]), !0))
            )
          }),
          (t.prototype.add = function(t) {
            this._selected !== t &&
              ...
              this.events.fire(i.SelectionEvents.beforeSelect, [t]) &&
                ((this._selected = t), this._data.update(t, { $selected: !0 }, !0), this.events.fire(i.SelectionEvents.afterSelect, [t])))
          }),
          t
        )
      })()
  ...
  function(t, e, n) {
    ...
    var r = n(27),
      ...
      a = n(30),
      l = n(31)
    for (var c in ((e.shapes = { line: r.Line, dash: r.Line, card: i.DiagramCard, 'img-card': o.DiagramImgCard, 'svg-card': s.DiagramSvgCard, text: l.TextShape }), a.renders))
      e.shapes[c] = a.FlowShape
    ...
    var o = n(0),
      s = (function(t) {
        ...
        return (
          i(e, t),
          (e.prototype.getMetaInfo = function() {
            return [{ id: 'title', label: 'Title', type: 'text' }, { id: 'text', label: 'Text', type: 'text' }, { id: 'img', label: 'Image', type: 'image' }]
          }),
          (e.prototype.setDefaults = function(t) {
    ...
    var o = n(0),
      ...
      l = (function(t) {
        ...
        return (
          ...
          (e.prototype.getMetaInfo = function() {
            return [{ id: 'title', label: 'Title', type: 'text' }, { id: 'text', label: 'Text', type: 'text' }]
          }),
          (e.prototype.getCss = function() {
            ...
            if (t.text) {
              ...
              return o.sv(
                'text',
                {
                  y: a[e],
                  x: t.width / 2,
                  'text-anchor': { left: 'start', center: 'middle', right: 'end' }[t.textAlign],
    ...
    var o = n(0),
      s = (function(t) {
        ...
        return (
          ...
          (e.prototype.getMetaInfo = function() {
            return [{ id: 'text', label: 'Content', type: 'text' }, { id: 'textProps', type: 'textProps', label: 'Text', alignments: !1 }]
          }),
          ...
          (e.prototype.setDefaults = function(t) {
            return (
              (t.width = 0),
              (t.height = 0),
              (t.fontColor = 'rgba(0,0,0,0.70)'),
              (t.fontSize = 14),
              (t.textAlign = 'center'),
              (t.lineHeight = 14),
              (t.fontStyle = 'normal'),
              (t.textVerticalAlign = 'center'),
              t
            )
          }),
          (e.prototype._getText = function() {
            ...
            if (t.text) {
              ...
              return o.sv(
                'text',
                { y: t.height, x: t.width, 'text-anchor': 'middle', class: 'dhx_item_text', 'font-size': t.fontSize, 'font-style': t.fontStyle, fill: t.fontColor },
                r
              )
            }
          }),
    ...
    var h = (function() {
      ...
      return (
        ...
        (t.prototype._onDrop = function() {
          if (this._canMove) {
            ...
            if (t && e.mode !== c.DragMode.source) {
              ...
              r.target.events.fire(s.DragEvents.beforeDrop, [r, n]) && (this._move(r, n), n.target.events.fire(s.DragEvents.dropComplete, [n.id, this._transferData.dropPosition])),
                this._endDrop()
            } else this._endDrop()
          } else this._endDrop()
        }),
        (t.prototype._onDragStart = function(t, e) {
          ...
          return n.events.fire(s.DragEvents.beforeDrag, [i, u]) && t
            ? (this._toggleTextSelection(!0), (this._transferData.target = n), (this._transferData.dragConfig = r), u)
            : null
        }),
        ...
        return (
          ...
          (t.prototype.remove = function(t) {
            return (
              !(t = t || this._selected) ||
              (!!this.events.fire(i.SelectionEvents.beforeUnSelect, [t]) &&
                (this._data.update(t, { $selected: !1 }), (this._selected = null), this.events.fire(i.SelectionEvents.afterUnSelect, [t]), !0))
            )
          }),
          (t.prototype.add = function(t) {
            this._selected !== t &&
              (this.remove(),
              this.events.fire(i.SelectionEvents.beforeSelect, [t]) &&
                ((this._selected = t), this._data.update(t, { $selected: !0 }), this.events.fire(i.SelectionEvents.afterSelect, [t])))
          }),
          t
        )
      })()
      ...
      s = (function() {
        ...
        return (
          ...
          (t.prototype._getCoords = function(t, e, n, r) {
            if (t.$shape.isConnector())
              return this._pressCoords ? { x: this._pressCoords.x * r - 50, y: this._pressCoords.y * r - 50 } : { x: t.points[0].x * r, y: t.points[0].y * r }
